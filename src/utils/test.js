const salaryExpectations = (salary) => {
	const { net, gross } = salary;
	if (net >= 1200 || gross >= 1800) return "That would do.";
	else return "Maybe we should negotiate a little bit.";
};
...
console.log(salaryExpectations(salary));
