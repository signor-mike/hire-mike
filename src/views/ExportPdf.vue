<template>
	<div id="document">
		...
		<main>
			<div class="column">
				<h4 class="title left">I am proficient and efficient with:</h4>
				<div
			...
			<div class="column">
				<div class="bio">
					...
					<p>
						<br />
						Started my career in customer service, I couldn't live
						another day in a terrorist state. And so I made a
						decision to move to Europe. I arrived to Canary Islands.
						Tenerife to be precise. In Spain I worked in hospitality
						as manager assistant.
						<br />
						I earned a lot of cross industry skills, such as:
						ability to represent business; determine customer needs
						or problems and propose a solution in everyone's best
						interest; and the skill I value the most: I learnt how
						to work with people of different cultures. I'd consider
						myself as a cosmopolitan person, although I've never
						tried the cocktail nor read the magazine.
						<br />
