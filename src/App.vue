...
export default {
  ...
  beforeMount: function () {
    if (window.matchMedia('(prefers-color-scheme: dark)').matches) {
      ...
      console.log(`The dark theme is set to ${this.$vuetify.theme.dark} by default, because my dear visitor prefers dark color scheme :)`)
    } else {
      this.$vuetify.theme.dark = false,
      console.log(`The light theme is set to ${this.$vuetify.theme.light} by default, because my dear visitor prefers light color scheme :)`)
    }
  },
